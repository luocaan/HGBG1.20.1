...
public class CarrotBowlBlock extends HorizontalFacingBlock {

    private static final VoxelShape SHAPE = VoxelShapes.cuboid(0.22, 0, 0.26, 0.80, 0.41, 0.89);

    public CarrotBowlBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        player.getHungerManager().add(
            ModFoodComponents.CARROT_BOWL.getHunger(),
            ModFoodComponents.CARROT_BOWL.getSaturationModifier()
        );
