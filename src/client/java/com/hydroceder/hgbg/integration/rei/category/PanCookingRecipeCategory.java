...
public class PanCookingRecipeCategory implements DisplayCategory<PanCookingRecipeDisplay> {

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.STOVE);
    }

    @Override
    public Text getTitle() {
        return Text.translatable("rei.hunger-begone.pan_cooking");
    }

    @Override
    public CategoryIdentifier<? extends PanCookingRecipeDisplay> getCategoryIdentifier() {
        return HgbgModREI.PAN_COOKING;
    }

    @Override
    public List<Widget> setupDisplay(PanCookingRecipeDisplay display, Rectangle bounds) {
